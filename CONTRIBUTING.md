...
If you have questions about how to use this component, please open a [GitHub Issue](https://github.com/ef-ctx/ng.cx.popover/issues).

If you find a bug in the source code or a mistake in the documentation, you can help us by
submitting an issue to our [GitHub Issue](https://github.com/ef-ctx/ng.cx.popover/issues). Even better you can submit a Pull Request
with a fix.
...
* Search [Pull Requests](https://github.com/ef-ctx/ng.cx.popover/pulls) for an open or closed Pull Request
...
* In GitHub, send a pull request to `ng.cx.popover:master`.
